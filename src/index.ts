/**
 * @cogworks/mcp — stdio↔HTTP bridge for the Cogworks MCP server.
 *
 * Local MCP clients (Claude Desktop, Cursor, Zed, …) speak the protocol
 * over stdio. Cogworks's Phase-3 HTTP transport at `/api/v1/mcp/` lets
 * remote agents connect over HTTPS. This package bridges the two:
 *
 *   client (stdio) ⇄ cogworks-mcp ⇄ cogworks (HTTP+SSE)
 *
